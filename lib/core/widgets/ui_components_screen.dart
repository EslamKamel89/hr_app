...
import 'package:hr/core/static_data/app_strings.dart';
import 'package:hr/core/themes/toogle_theme_switch.dart';
import 'package:hr/core/widgets/bottom_navigation_bar.dart';
import 'package:hr/core/widgets/default_drawer.dart';
import 'package:hr/core/widgets/default_screen_padding.dart';
import 'package:hr/core/widgets/language_selector.dart';
import 'package:hr/core/widgets/sizer.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [Icon(Icons.home), Sizer(), Icon(Icons.star), Sizer(), Icon(Icons.settings)],
              ),
              const Sizer(),
              ElevatedButton(
                onPressed: () {
