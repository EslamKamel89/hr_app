...
class CompanyFormController {
  ...
  Future<ApiCrudResponseModel<CompanyLegalModel>> legalShow(
    int companyId,
  ) async {
  ...
  Future<ApiCrudResponseModel<CompanyAttachmentsModel>> attachmentShow(
    int companyId,
  ) async {
    final t = prt('attachmentShow - CompanyFormController ');
    try {
      final response = await api.get(
        '${EndPoint.companyAttachments}/$companyId',
      );
      CompanyAttachmentsModel companyAttachmentsModel =
          CompanyAttachmentsModel.fromJson(response['attachments'][0]);
      companyAttachmentsModel.path = response['path'];
      // showSnackbar('Success', 'Data Saved Successfully', false);
      return pr(
        ApiCrudResponseModel(
          showResponse: ResponseEnum.success,
          data: companyAttachmentsModel,
        ),
        t,
      );
    } catch (e) {
  ...
  Future<ApiCrudResponseModel<CompanyAttachmentsModel>> attachmentUpsert(
    ...
    try {
      ...
      CompanyAttachmentsModel companyAttachmentsModel =
          CompanyAttachmentsModel.fromJson(response['attachments']);
      companyAttachmentsModel.path = response['path'];
      showSnackbar('Success', 'Data Saved Successfully', false);
      return pr(
        ApiCrudResponseModel(
