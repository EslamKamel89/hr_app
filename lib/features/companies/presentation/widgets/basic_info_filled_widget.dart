...
class CompanyBasicInfoFilledWidget extends StatelessWidget {
  const CompanyBasicInfoFilledWidget({super.key, required this.child, required this.currentTab});
  final Widget child;
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CompanyFormCubit, CompanyFormState>(
      buildWhen: (previous, current) {
        return (previous.currentTab != currentTab && current.currentTab == currentTab);
      },
